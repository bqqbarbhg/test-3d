...
set LDFlags= -opt:ref -NODEFAULTLIB:MSVCRT user32.lib glu32.lib gdi32.lib shell32.lib ws2_32.lib DbgHelp.lib opengl32.lib assimp-vc110-mtd.lib glfw3.lib -LIBPATH:D:\lib
